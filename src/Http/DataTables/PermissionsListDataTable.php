...
class PermissionsListDataTable extends AbstractDataTables
{
    ...
    public function headings()
    {
        return [
            ...
            'name' => [
                'title' => trans('edutalk-acl::datatables.permission.heading.name'),
                'width' => '40%',
            ],
            'slug' => [
                'title' => trans('edutalk-acl::datatables.permission.heading.slug'),
                'width' => '30%',
            ],
            'module' => [
                'title' => trans('edutalk-acl::datatables.permission.heading.module'),
                'width' => '30%',
            ],
        ];
    }
