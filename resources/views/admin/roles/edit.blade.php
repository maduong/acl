        ...
        <div class="column main">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        <i class="icon-layers font-dark"></i> {{ trans('edutalk-core::base.form.basic_info') }}
                    </h3>
                </div>
                <div class="box-body">
                    {!! Form::open(['class' => 'js-validate-form', 'url' => route('admin::acl-roles.edit.post', ['id' => $object->id])]) !!}
                    <div class="form-group">
                        <label class="control-label">{{ trans('edutalk-acl::base.form.name') }}</label>
                        <input type="text"
                               name="name"
                    ...
                    <div class="form-group">
                        <label class="control-label">{{ trans('edutalk-acl::base.form.slug') }}</label>
                        <input type="text"
                    ...
                    <div class="form-group">
                        <label class="control-label">{{ trans('edutalk-acl::base.form.related_permissions') }}</label>
            ...
            @php do_action(BASE_ACTION_META_BOXES, 'main', Edutalk_ACL_ROLE, $object) @endphp
        </div>
    </div>
@endsection
